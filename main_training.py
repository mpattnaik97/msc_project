...
model, predictor_sizes = original_ssd(return_predictor_sizes = True, l2_regularization=0.0005) # This creates the scaled ssd model
...
log_results = keras.callbacks.CSVLogger('../results/original_ssd.log', append=True)

# saves the model weights at every 20 epochs into a new file
checkpoint = keras.callbacks.ModelCheckpoint(filepath='../saved_models/original_ssd_weights_{epoch:02d}.hdf5', save_weights_only=True, period = 20)
